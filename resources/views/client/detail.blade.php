              ...
              <div class="col-xl-6">
                ...
                <div class="product-single-thumb">
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <a class="lightbox-image" data-fancybox="gallery" href="#">
                          <img src="{{ Storage::url($product->variant->first()->image_main) }}" width="570" height="541" alt="Image-HasTech">
                        </a>
                      </div>
                    </div>
                  </div>
                  <div class="swiper-container single-product-nav single-product-nav-slider">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <img src="{{ Storage::url($product->variant->first()->image_main) }}" width="127" height="127" alt="Image-HasTech">
                      </div>
                      <div class="swiper-slide">
                        <img src="{{ Storage::url($product->variant->first()->image_main) }}" width="127" height="127" alt="Image-HasTech">
                      </div>
                ...
                <div class="product-single-info">
                  ...
                  <div class="product-color">
                    ...
                    <ul class="color-list">
                      ...
                      <li style="font-size: 10px;">{{ $variant->color }}</li>
                      @endforeach
                    </ul>
                  </div>
                  <!-- Color -->
