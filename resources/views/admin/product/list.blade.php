...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="{{ route('products.addProduct') }}"><button type="button" class="btn btn-secondary btn-sm">Nhập thêm</button></a>
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <a href="{{ route('products.updateProduct', $value->id) }}"><button class="btn btn-warning">Sửa</button></a>
                                <form action="{{ route('products.deleteProduct') }}" method="post">
                                    @csrf
                                    @method('delete')
